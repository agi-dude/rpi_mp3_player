...
// Get a specific playlist - FIXED ROUTE
...
// Add a track to playlist - FIXED ROUTE
...
// Remove a track from playlist - FIXED ROUTE
router.delete('/:playlistId/tracks/:trackIndex', async (req, res) => {
  try {
    const playlistId = req.params.playlistId;
